<!-- Source note: root /release_notes.md remains the source of truth until fully migrated. -->
...
- Cancel SWRSWEEP by touching the display or a mouse click
...
- Added Out-Of-Band and license class indicators
 ...
 - Added swrsweep
    ...
    + touching the display or a mouse click cancels sweep
